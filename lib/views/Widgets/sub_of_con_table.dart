          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                _buildMobileDataRow(
                    'عدد عمليات الصرف', '${subconsumer.numOfOP}'),
                _buildMobileDataRow('وصف إضافي', '${subconsumer.description}'),
              ],
            ),
          ),
        );
    ...
    return [
      ...
      DataColumn(
        label: _buildColumnHeader(
            'عدد عمليات الصرف', isMobile, isTablet, isDesktop,
            width: isTablet ? 80.w : (isDesktop ? 90.w : 100.w)),
      ),
      DataColumn(
        label: _buildColumnHeader('وصف إضافي', isMobile, isTablet, isDesktop,
            width: isTablet ? 80.w : (isDesktop ? 90.w : 100.w)),
      ),
      DataColumn(
        label: _buildColumnHeader(
